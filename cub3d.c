...
void	ft_cub3d(t_game *game)
{
	...
	//mlx_hook(game->win_ptr, KeyPress, KeyPressMask, ft_exit, game->mlx_ptr);
	mlx_hook(game->win_ptr, KeyRelease, KeyReleaseMask, ft_release, game->player);
	//mlx_hook(game->win_ptr, DestroyNotify, StructureNotifyMask, mlx_loop_end, game->mlx_ptr);
